...
**Success Criteria** (what must be TRUE):
  ...
  2. All required env vars (STRIPE_SECRET_KEY, STRIPE_WEBHOOK_SECRET, STRIPE_PRO_PRICE_ID, STRIPE_TOPUP_PRICE_ID, NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY) are present in local, staging, and production environments with no NEXT_PUBLIC_ prefix on secrets
...
|-------|----------------|--------|-----------|
| 1. Schema + Infrastructure Foundation | 0/? | Not started | - |
